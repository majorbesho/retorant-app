...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('variations/{variation}/options', [VariationController::class, 'storeOption'])->name('variations.store_option');
    Route::delete('variation_options/{option}', [VariationController::class, 'destroyOption'])->name('variation_options.destroy');
    ...
    // Admin Routes
    Route::middleware(['can:manage-requests'])->prefix('admin')->name('admin.')->group(function () {
